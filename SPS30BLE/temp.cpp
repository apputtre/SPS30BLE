...
#include "SPS30BLE/BLESPS30MeasurementCharacteristic.h"

#define BLE_UUID "86E97AEE-4223-4C52-ABB7-072F7D4271AB"

BLEService sps30Service("86E97AEE-4223-4C52-ABB7-072F7D4271AB");
BLESPS30MeasurementCharacteristic sps30Characteristic("86E97AEE-4223-4C52-ABB7-072F7D4271AB", BLERead);
...
void setup() {
  ...
  sps30Service.addCharacteristic(sps30Characteristic);
...
void loop() {
  ...
  if (ret < 0) {
    ...
    // broadcast the measurement

    sps30Characteristic.writeValue(m);
